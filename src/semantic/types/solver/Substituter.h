...
public:
  ...
  virtual void endVisit(TopModeVar *element) override;
  virtual void endVisit(TopMu *element) override;
  virtual void endVisit(ReferenceType *element) override;
  virtual void endVisit(ReferenceMode *element) override;
