...
public:
  ...
  bool matchesFunctor(const Term &other) const override;
  bool preferAsRepresentativeOver(const Term &other) const override;
  bool unifiesByStructureOnlyWith(const Term &other) const override;
