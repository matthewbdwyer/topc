...
public:
  ...
  virtual bool visit(TopModeVar *element) { return true; }
  virtual void endVisit(TopModeVar *element) {}
  virtual bool visit(ReferenceType *element) { return true; }
  virtual void endVisit(ReferenceType *element) {}
  virtual bool visit(ReferenceMode *element) { return true; }
  virtual void endVisit(ReferenceMode *element) {}
